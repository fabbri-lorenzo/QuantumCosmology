...
\input{Sections/Section2/P(x,phi).tex}
\newpage

\section{Quantum Inflation}\label{sec:section3}
\input{Sections/Section3/Intro.tex}

\input{Sections/Section3/CurvedST.tex}
\input{Sections/Section3/CosmPT.tex}
\input{Sections/Section3/HydroPT.tex}
\input{Sections/Section3/SingCompFluid.tex}
\newpage

\section{Perturbations During Inflation}\label{sec:section4}
\input{Sections/Section4/ScalarPT.tex}
\input{Sections/Section4/TensorPT.tex}
\input{Sections/Section4/LythBound.tex}
\input{Sections/Section4/Observables.tex}

\section{The last scattering surface}\label{sec:LST}
\input{Sections/Section5/Intro.tex}
\input{Sections/Section5/CMBAnisotropies.tex}
\input{Sections/Section5/CMBMultipoles.tex}
\input{Sections/Section5/CMBSWPlateau.tex}
