...
\documentclass[a4paper,12pt,oneside,customfont,custombib,PageStyleII]{Settings/PhDThesisPSnPDF}
...
\input{Sections/Chapter1/introBD.tex}
\input{Sections/Chapter1/EOMBD.tex}
\input{Sections/Chapter1/transformations.tex}

\chapter{\texorpdfstring{$f(R)$}{f(R)} Theories}\label{chap:chapter2}
\input{Sections/Chapter2/introfR.tex}
\input{Sections/Chapter2/expansion.tex}


\chapter{Spontaneous Scalarization}\label{chap:SS}
\input{Sections/Chapter3/introSS.tex}
\input{Sections/Chapter3/tachyonic.tex}
\input{Sections/Chapter3/Damour.tex}
